    ...
    public function init() {
        ...
        return array( 
			...
			40 => array(
                ...
                'desc' => __( 'E-mail field label', 'yit' ),
			...
			60 => array(
                ...
                'desc' => __( 'Newsletter hidden fiel. (usage: name1=value1&name2=value2")', 'yit' ),
                'std'  => '',
            ),
			70 => array(
                'id'   => 'popup_method',
                'type' => 'select',
                'name' => __('Method', 'yit'),
                'desc' => __( 'Want to use a a popup?', 'yit' ),
                'options'  => 	array(
					'post' => __('POST', 'yit'),
					'get' => __('GET', 'yit')
				),
