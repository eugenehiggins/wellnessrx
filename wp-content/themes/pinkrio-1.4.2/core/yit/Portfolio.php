 ...
 * @since 1.0.0
 */
function yit_add_work_support( $portfolio_type, $supports ) {
    yit_get_model('portfolio')->add_work_support( $portfolio_type, $supports );
}       
...
/** 
 * Print the link for next portfolio        
 * 
 * @since 1.0  
 */   
function yit_next_work() {       
    return yit_get_model('portfolio')->next_work();
}
 ...
 * @since 1.0  
 */   
function yit_previous_work() {       
    return yit_get_model('portfolio')->previous_work();
}               