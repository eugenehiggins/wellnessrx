...
<div class="wrap">
	...
	<h2>
		...
		<?php if ( file_exists( dirname(__FILE__).'/sampleslider/sample_sliders.txt' ) ) : ?><a href="?page=layerslider&action=import_sample" class="add-new-h2"><?php _e('Import sample sliders', 'LayerSlider') ?></a><?php endif; ?>
	</h2>
